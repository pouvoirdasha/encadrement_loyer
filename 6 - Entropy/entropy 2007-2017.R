...
# =========================================================
# 4. Construction des différences annuelles 2007-2017
#    + différence post 2017-2022
# =========================================================
...
#    Il faut toutes les années 2007-2017 + 2022
# =========================================================

required_vars <- c(
  paste0("y_", 2007:2017),
  "y_2022",
  paste0("d_", sprintf("%02d", 7:16), "_", sprintf("%02d", 8:17)),
  "d_17_22"
)
...
diff_vars <- paste0("d_", sprintf("%02d", 7:16), "_", sprintf("%02d", 8:17))
...
cat("\n--- Vérification du matching sur les différences annuelles 2007-2017 ---\n")
...
formula_ctrl <- as.formula(
  paste("d_17_22 ~ treated +", paste(diff_vars, collapse = " + "))
)
...
# =========================================================
# 10. Préparer les données de plot
# =========================================================

plot_years <- c(2007:2017, 2022)
...
ggplot(trend_plot, aes(x = annee, y = mean_outcome, color = groupe, group = groupe)) +
  ...
  scale_x_continuous(breaks = c(2007:2017, 2022)) +
  labs(
    title = "Évolution de nb_RP_en_loc : Paris vs contrôle pondéré",
    subtitle = "Calage par entropy balancing sur toutes les différences annuelles 2007-2017",
    x = "Année",
...
ggplot(trend_plot_index, aes(x = annee, y = evol_depuis_2007, color = groupe, group = groupe)) +
  ...
  labs(
    ...
    subtitle = "Pré-trend calé sur toutes les variations annuelles 2007-2017",
    x = "Année",
...
ggplot(trend_full, aes(x = annee, y = mean_outcome, color = groupe, group = groupe)) +
  ...
  labs(
    title = "Évolution de nb_RP_en_loc : Paris vs contrôle pondéré",
    subtitle = "Poids entropy balancing calibrés sur les pré-trends 2007-2017",
    x = "Année",
    y = "Moyenne pondérée de nb_RP_en_loc",
    color = "Groupe"
  ) +
...
# =========================================================
# 14. Tendance annuelle fine sur la période pré-traitement
# =========================================================
...
ggplot(trend_micro, aes(x = annee, y = mean_outcome, color = groupe, group = groupe)) +
  ...
  labs(
    title = "Tendance annuelle 2007–2017",
...
# =========================================================
# 15. ATT total et en pourcentage
# =========================================================
