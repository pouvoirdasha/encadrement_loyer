...
for (commune in as.character(c(75101:75120))) {
  ...
  syn_classique_res = syn_classique_res[Time > 2016]
  
  nb_RP_loc = dt_synth[COM == commune & annee> 2016, c("annee", "nb_RP_en_loc")]
  ...
  syn_jack_res = syn_jack_res[Time > 2016]
  ...
  syn_ridge_res = syn_ridge_res[Time > 2016]
  ...
  syn_ridge_FE_res = syn_ridge_FE_res[Time > 2016]
  ...
  syn_ridge_cov_res = syn_ridge_cov_res[Time > 2016]
...
fwrite(res_synth, "resultats_ATT_2017.csv", sep = ";", dec = ",")
